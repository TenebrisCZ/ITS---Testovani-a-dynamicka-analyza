Feature: Costumer creates order
    ...
    # 1
	Scenario Outline: Adding item to shopping cart
		Given user is at "<item>" detail page
    ...
    # 2
    Scenario Outline: Check shopping cart
    ...
    # 6
    Scenario Outline: Continue to checkout with items out of stock or unavailable
        Given user is at shopping cart page
        And "<item>" is in shopping cart
