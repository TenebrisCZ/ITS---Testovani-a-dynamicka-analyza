Feature: Items sorting and searching
	...
	# 8
	Scenario: User wants to view items in category
		Given user is on homepage
	...
	# 10
	Scenario: User wants to view subcategories
		Given user is on homepage
	...
	# 11
	Scenario: User wants to view items in subcategory
		Given user is on homepage
	...
	# 13
	Scenario: User wants to view item detail
		Given user is on "<category>" category page
