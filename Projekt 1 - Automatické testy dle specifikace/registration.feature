Feature: User registration
    ...
    # 14
    Scenario: User wants to create account at checkout
    ...
    # 15
    Scenario: User wants to create account at checkout - missing required
        Given unregistered user is at "<item>" checkout page
        When "Register Account" option is sellected
    ...
    # 16
    Scenario: User won't fill all required fields in registration form
    ...
    Scenario: Registered user drop-down menu
        Given logged in user is on homepage
